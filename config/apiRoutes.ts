export const apiRoutes = {
	...
	user: {
		lastSelectedTrip: (tripId: string) => ({
			url: `/users/last-trip`,
			method: "POST",
			data: { tripId },
		}),
	...
	trip: {
		createTrip: () => ({ url: "/trips", method: "POST" }),
		...
		sharedItems: (tripId: string) => ({
			url: `/packing-items/${tripId}/shared`,
			method: "GET",
		}),
		updateSharedItem: (itemId: string) => ({
			url: `/packing-items/${itemId}`,
			method: "PATCH",
		}),
		...
		checklists: (tripId: string) => ({
			url: `/checklists/${tripId}`,
			method: "GET",
		}),
		createChecklist: (tripId: string) => ({
			url: `/checklists/${tripId}`,
			method: "POST",
		}),
